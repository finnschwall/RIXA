...
urlpatterns = [
    ...
    path('user_login_old/', views.user_login_old, name='account_user_login_old'),
    path('signup/', views.register_user, name='account_signup'),
    path('signup_alternative/', views.register_user_legacy, name='account_signup_alternative'),
