"""
Copied from Pyro5 (https://github.com/irmen/Pyro5/)
RIXA uses pyro extensively, however pyro has no native async support. These are monkeypatches for that and other
minor stuff RIXA needs.
...
from Pyro5 import config, core, errors, serializers, socketutil, protocol, client
